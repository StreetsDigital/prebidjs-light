...
import { OverviewTab } from './PublisherDetail/OverviewTab';
import { ConfigTab } from './PublisherDetail/ConfigTab';
import { WebsitesTab } from './PublisherDetail/WebsitesTab';
import { AdUnitsTab } from './PublisherDetail/AdUnitsTab';
import { BuildTab } from './PublisherDetail/BuildTab';
import { ABTestsTab } from './PublisherDetail/ABTestsTab';
import { AuctionInspectorTab } from './PublisherDetail/AuctionInspectorTab';
import { RevenueForecastingTab } from './PublisherDetail/RevenueForecastingTab';
import { OptimizationRulesTab } from './PublisherDetail/OptimizationRulesTab';
import { NotificationsTab } from './PublisherDetail/NotificationsTab';
import { CustomReportsTab } from './PublisherDetail/CustomReportsTab';
import type {
  Publisher,
  EditFormData,
  AdUnit,
  ...
  const tabs: Tab[] = [
    {
      ...
      content: (
        <OverviewTab
          ...
          onRegenerateApiKey={handleRegenerateClick}
          onAssignAdmin={handleOpenAssignAdminModal}
    ...
    },
    {
      ...
      content: (
        <ConfigTab
          ...
          onEditConfigClick={handleEditConfigClick}
          onVersionHistoryClick={handleVersionHistoryClick}
          onUserIdModuleConfigClick={handleUserIdModuleConfigClick}
          onUserIdModuleToggle={handleUserIdModuleToggle}
          onConsentConfigClick={handleConsentConfigClick}
          onPriceFloorsConfigClick={handlePriceFloorsConfigClick}
          onVersionSelect={handleVersionSelect}
          onVersionHistoryBack={handleVersionHistoryBack}
    ...
    },
    {
      ...
      content: (
        <WebsitesTab
          ...
          onEditWebsite={handleEditWebsiteClick}
          onDeleteWebsite={handleDeleteWebsiteClick}
        />
      ),
    },
    {
      ...
      content: (
        <AdUnitsTab
          websites={websites}
          adUnitsByWebsite={adUnitsByWebsite}
          onAddAdUnit={handleAddAdUnitClick}
          onEditAdUnit={handleEditAdUnitClick}
          onDuplicateAdUnit={handleDuplicateAdUnitClick}
          onDeleteAdUnit={handleDeleteAdUnitClick}
    ...
    },
    {
      ...
      content: (
        <BuildTab
          publisher={publisher}
          builds={builds}
          publisherBidders={publisherBidders}
          adUnitsByWebsite={adUnitsByWebsite}
          token={token || ''}
          isBuildTriggering={isBuildTriggering}
          setIsBuildTriggering={setIsBuildTriggering}
          setBuilds={setBuilds}
          onDeleteBuild={handleDeleteBuildClick}
          onRefreshBuilds={fetchBuilds}
          onAddToast={addToast}
        />
      ),
    },
    {
      ...
      content: (
        <ABTestsTab
          publisher={publisher}
          abTests={abTests}
          onCreateAbTest={handleCreateAbTestClick}
          onEditAbTest={handleEditAbTestClick}
          onDeleteAbTest={handleDeleteAbTestClick}
          onStatusChange={handleAbTestStatusChange}
          getStatusBadge={getStatusBadge}
        />
      ),
    },
    ...
    },
    {
      ...
      label: 'Automation',
      content: <OptimizationRulesTab publisher={publisher} />,
    },
    {
      id: 'auction-inspector',
      label: 'Live Inspector',
      content: <AuctionInspectorTab publisher={publisher} />,
    },
    {
      id: 'revenue-forecasting',
      label: 'Revenue Insights',
      content: <RevenueForecastingTab publisher={publisher} />,
    },
    {
      id: 'notifications',
      label: 'Alerts & Notifications',
      content: <NotificationsTab publisher={publisher} />,
    },
    {
      id: 'custom-reports',
      label: 'Custom Reports',
      content: <CustomReportsTab publisher={publisher} />,
    },
  ];
