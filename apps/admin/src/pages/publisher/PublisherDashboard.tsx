    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="mt-4 text-sm text-green-600">+12% from last week</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="mt-4 text-sm text-green-600">+8% from last week</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="mt-4 text-sm text-red-600">-2% from last week</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="mt-4 text-sm text-green-600">+5% from last week</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div>
              <p className="font-medium text-gray-900">Create Ad Unit</p>
              <p className="text-sm text-gray-500">Add a new ad placement</p>
            </div>
          </a>

          <a
            href="/publisher/get-code"
            className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
          >
            ...
            <div>
              <p className="font-medium text-gray-900">Get Embed Code</p>
              <p className="text-sm text-gray-500">Copy your integration code</p>
            </div>
          </a>
